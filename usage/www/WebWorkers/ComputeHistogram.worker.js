(function () {
	...
	}, "/$$rollup_base$$/node_modules/safe-buffer");
	...
	function ReadableState(options, stream, isDuplex) {
	  Duplex = Duplex || commonjsRequire("./_stream_duplex", "/$$rollup_base$$/node_modules/readable-stream/lib");
	...
	function WritableState(options, stream, isDuplex) {
	  Duplex$1 = Duplex$1 || commonjsRequire("./_stream_duplex", "/$$rollup_base$$/node_modules/readable-stream/lib");
	  options = options || {}; // Duplex streams are both readable and writable, but share
	  // the same options object.
	  // However, some cases require setting options to different
	  // values for the readable and the writable sides of the duplex stream,
	...
	function Writable(options) {
	  Duplex$1 = Duplex$1 || commonjsRequire("./_stream_duplex", "/$$rollup_base$$/node_modules/readable-stream/lib"); // Writable ctor is applied to Duplexes, too.
	...
	commonjsRegister("/$$rollup_base$$/node_modules/readable-stream/lib/_stream_duplex.js", function (module, exports) {
	/*<replacement>*/
	...
	inherits_browser(Duplex, Readable);
	...
	function RegisterPromise(fn) {
	  var handlers = _defineProperty$2({}, DEFAULT_HANDLER, fn);
	  ...
	  var server = new (function (_TinyEmitter) {
	    ...
	    function WorkerRegister() {
	      _classCallCheck$1(this, WorkerRegister);
	...
	var TransferableResponse = function TransferableResponse(payload, transferable) {
	  _classCallCheck$1(this, TransferableResponse);
