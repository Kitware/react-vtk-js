    ...
    <div style={{width: '100vw', height: '100vh'}}>
      <div style={{width: '50vw', height: '100vh', display: 'inline-block'}}>
        ...
        >
          ...
          <Slider max={4095} value={colorLevel} setValue={setColorLevel} style={{top: '30px', left: '5px'}} />
          <Slider max={4095} value={colorWindow} setValue={setColorWindow} style={{top: '30px', left: '305px'}} />
